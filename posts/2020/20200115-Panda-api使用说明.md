...
Panda api的接口文档工具是一个简单、易用、又强大的接口文档管理工具。这里我不想讲为什么自己重复造轮子，也不想去讲他有多强大，`Talk is cheap, Show me your code.`。我们直接从一个例子开始了解他吧。
...
[Linux下安装配置](https://www.debugmyself.com/p/2020/1/17/Mac%E4%B8%8B%E5%AE%89%E8%A3%85Panda-Api/)      
[Windows下安装配置](https://www.debugmyself.com/p/2020/1/18/Windows%E4%B8%8B%E5%AE%89%E8%A3%85Panda-Api/)    

### 2 下载带有样例的Panda api文件

[Panda Api for Mac 0.5 with basic example](https://github.com/arlicle/panda-api/releases/download/0.2/panda-api_mac_0.2.tar)  

下载后解压缩该文件夹，进入该文件夹，文件夹内容结构如下：
```.language-shell
ls
